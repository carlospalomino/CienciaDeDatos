...
## Step1: Reading data
data <- read.table("./3.-ExploratoryDataAnalysis/TareaSemana1/household_power_consumption.txt", sep = ";", header = T, stringsAsFactors = F)
...
## Step3:Extract data for the following days 2007-02-01, 2007-02-02
selected_dataset <- data[which(data$Date %in% as.Date(c("2007-02-01", "2007-02-02"))),] 


## Step4: Change columns with energy submetering to numeric
...
## Step5: Plotting line plot - Energy sub metering vs. weekdays
